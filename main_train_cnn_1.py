...
def main() -> None:
    ...
    # Resolve split dir (support relative under project root or alongside YAML)
    ...
    # test set optional (we’ll evaluate on val during training; user can add a test script)
    test_ids = None
    ...
    # --------------- Model ----------------
    # pick backbone: CLI override > YAML options.image_backbone > default
